...
\author[V]{$$$$Substitute Professor\thanks{Chapter 5: Group}: \textbf{Yigeng Zhao}}
...
\begin{propositionenv}
    ...
    $$(x_i)_{i\in I}\sim (y_i)_{i\in I}\Rightarrow \forall i\in I, x_i\sim y_i$$
...
\begin{exampleenv}
    ...
    $$(x_1\sim x_2 \text{ and } y_1\sim y_2)\Rightarrow x_1*y_1\sim x_2*y_2$$
    Or equivalently, the equivalence relation $R$ on $X\times X$ defined by 
    $$(x_1,y_1)R(x_2,y_2)\Rightarrow x_1\sim x_2\text{ and }y_1\sim y_2$$
