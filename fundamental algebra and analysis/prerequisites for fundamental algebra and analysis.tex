...
$\dagger$This chapter was written in pre-course at first,then added some sections in make-up courses,which titled "Ordering".Some notations haven't been changed yet and some sections have the same knowledge.It's a bit mess.
...
\begin{propositionenv}
   ...
   \newline
   (2) Suppose that $I$ has a infimum $b$ in $X,\forall x\in I,\interval[open left]{x}{b}\subseteq I$
\end{propositionenv}
\begin{remark}
